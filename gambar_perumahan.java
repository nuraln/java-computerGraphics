...
public class Gambar_Perumahan extends JApplet{
public static void main (String [] args){
JFrame frame= new JFrame ();
frame.setTitle("_Perumahan_Kota");
frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
JApplet applet= new Gambar_Perumahan ();
applet.init();
...
g.setColor(Color.black);
Font font1 = new Font("mistral", Font.BOLD, 26);
g.setFont(font1);
g.drawString("NamaKamu", 457, 520);
}
}
}